...
$result = $conn->query("SELECT * FROM iso_codes ORDER BY code ASC");
$iso_codes = $result->fetch_all(MYSQLI_ASSOC);
$conn->close();
?>
...
<head>
  ...
  <title>AdminLTE 3 | ISO Codes</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">ISO Codes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of ISO Codes</h3>
                <div class="card-tools">
                  <a href="iso-codes-form.php" class="btn btn-primary btn-sm">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="isoCodesTable" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>ID</th>
                    <th>Code</th>
                  ...
                  <tbody>
                  <?php foreach ($iso_codes as $iso_code): ?>
                  <tr>
                    <td><?php echo htmlspecialchars($iso_code['id']); ?></td>
                    <td><?php echo htmlspecialchars($iso_code['code']); ?></td>
                    <td><?php echo htmlspecialchars($iso_code['description'] ?? 'N/A'); ?></td>
                    <td>
                      <a href="iso-codes-form.php?id=<?php echo htmlspecialchars($iso_code['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="iso-codes-delete.php?id=<?php echo htmlspecialchars($iso_code['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this ISO code?')">
