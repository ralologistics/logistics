...
// Get cart job details
$stmt = $conn->prepare("SELECT cjb.*, 
...
$stmt = $conn->prepare("SELECT c.*, 
                        ...
                        WHERE c.job_type = 'cart' AND c.job_id = ? 
                        ORDER BY c.id ASC");
$stmt->bind_param("i", $id);
$stmt->execute();
...
<head>
  ...
  <title>AdminLTE 3 | Cart Job View</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cart Job Details</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="cart-job-list.php">Cart Jobs</a></li>
          ...
          <div class="col-md-3">
            <div class="card card-primary">
              ...
              <div class="card-footer">
                <a href="cart-job-form.php?id=<?php echo $id; ?>" class="btn btn-warning btn-sm">
                  <i class="fas fa-edit"></i> Edit
                </a>
                <a href="cart-job-list.php" class="btn btn-default btn-sm">
