...
<head>
  ...
  <title>AdminLTE 3 | Services</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="services-form.php" class="btn btn-primary btn-sm">
              ...
              <div class="card-body">
                <table id="servicesTable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="services-form.php?id=<?php echo htmlspecialchars($service['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="services-delete.php?id=<?php echo htmlspecialchars($service['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this service?')">
