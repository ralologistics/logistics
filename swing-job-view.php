...
// Get swing job details
$stmt = $conn->prepare("SELECT sjb.*, 
                        c.name as customer_name, 
                        c.code as customer_code,
                        jb.booking_id as booking_ref
                        FROM swing_job_bookings sjb 
                        LEFT JOIN customers c ON sjb.customer_id = c.id 
                        LEFT JOIN job_bookings jb ON sjb.job_booking_id = jb.id 
                        WHERE sjb.id = ?");
...
$stmt = $conn->prepare("SELECT c.*, 
                        ...
                        WHERE c.job_type = 'swing' AND c.job_id = ? 
                        ORDER BY c.id ASC");
$stmt->bind_param("i", $id);
$stmt->execute();
...
<head>
  ...
  <title>AdminLTE 3 | Swing Job View</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Swing Job Details</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="swing-job-list.php">Swing Jobs</a></li>
          ...
          <div class="col-md-3">
            <div class="card card-primary">
              ...
              <div class="card-footer">
                <a href="swing-job-form.php?id=<?php echo $id; ?>" class="btn btn-warning btn-sm">
                  <i class="fas fa-edit"></i> Edit
                </a>
                <a href="swing-job-list.php" class="btn btn-default btn-sm">
                      ...
                      <tbody>
                        <?php foreach ($containers as $idx => $c): ?>
                          <tr>
                            ...
                            <td>
                              <?php if (!empty($c['ready_now'])): ?><span class="badge badge-success">Ready Now</span><?php endif; ?>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
