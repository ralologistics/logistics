...
$conn->query("DROP TABLE IF EXISTS swing_job_bookings");

// Create table with EXACT matching types
$sql = "
CREATE TABLE swing_job_bookings (
    ...
    CONSTRAINT fk_swing_customer
        FOREIGN KEY (customer_id)
        REFERENCES customers(id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,

    CONSTRAINT fk_swing_job
...
if ($conn->query($sql)) {
    echo "✅ swing_job_bookings table created successfully.";
} else {
