...
<head>
  ...
  <title>AdminLTE 3 | Countries</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="country-form.php" class="btn btn-primary btn-sm">
              ...
              <div class="card-body">
                <table id="countriesTable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($country['iso_alpha2'] ?? 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($country['iso_alpha3'] ?? 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($country['numeric_code'] ?? 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($country['phone_code'] ?? 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($country['currency'] ?? 'N/A'); ?></td>
                    <td><?php echo htmlspecialchars($country['continent'] ?? 'N/A'); ?></td>
                    <td>
                    ...
                    <td>
                      <a href="country-form.php?id=<?php echo htmlspecialchars($country['id']); ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="country-delete.php?id=<?php echo htmlspecialchars($country['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this country?')">
