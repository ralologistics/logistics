...
$result = $conn->query("SELECT * FROM ship_types ORDER BY type_name ASC");
$ship_types = $result->fetch_all(MYSQLI_ASSOC);
$conn->close();
?>
...
<head>
  ...
  <title>AdminLTE 3 | Ship Types</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Ship Types</h3>
                <div class="card-tools">
                  <a href="ship-type-form.php" class="btn btn-primary btn-sm">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="shipTypesTable" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>ID</th>
                    <th>Type Name</th>
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($ship_type['type_name']); ?></td>
                    <td><?php echo $ship_type['created_at'] ? date('Y-m-d H:i', strtotime($ship_type['created_at'])) : 'N/A'; ?></td>
                    <td><?php echo $ship_type['updated_at'] ? date('Y-m-d H:i', strtotime($ship_type['updated_at'])) : 'N/A'; ?></td>
                    <td>
                      <a href="ship-type-form.php?id=<?php echo $ship_type['id']; ?>" class="btn btn-warning btn-sm">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="ship-type-delete.php?id=<?php echo $ship_type['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this ship type?')">
